import { VolleyballBg } from "./VolleyballBg";
    ...
    <section className={styles.hero} id="hero">
      ...
      <div className={styles.content}>
        <p className={styles.badge}>
          ...
          Entrenador Profesional de Voleibol
        </p>
        <h1 className={styles.title}>
          Manuel <span className={styles.accent}>Pernia</span>
        </h1>
        <p className={styles.subtitle}>
          Transforma tu juego con entrenamiento profesional. Técnica, estrategia
          y mentalidad ganadora para voleibolistas de todos los niveles.
        </p>
